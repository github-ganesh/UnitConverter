...
namespace Dimensions.Converter
{
   ...
   public class SpeedUnit<T> : CoherentUnitBase where T : PhysicalQuantityBase
   {
      /// <summary>
      ...
      public SpeedUnit(T length, TimeUnit time)
         : base(new UnitCompositeCollection() { new MultipliedByUnit(length.Unit, 1), new DividedByUnit(time, 1) })
      {
