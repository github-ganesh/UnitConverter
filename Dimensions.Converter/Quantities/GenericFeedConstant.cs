...
{
   /// <summary>
   /// Represents a feed constant based on units per rotation.
   /// </summary>
   
   public class GenericFeedConstant
      : PhysicalQuantityBase, IComparable<GenericFeedConstant>
   {
      ...
      protected GenericFeedConstant(double value, GenericFeedConstantUnit unit)
         : base(value, unit)
      {
      }
      ...
      {
         get { return Quantity.GenericFeedConstant; }
      }
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      public static GenericFeedConstant operator +(GenericFeedConstant x, GenericFeedConstant y)
      {
         return Add(x, y);
      }
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      public static GenericFeedConstant operator +(GenericFeedConstant x, int y)
      {
         return Add(x, y);
      }
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      public static GenericFeedConstant operator +(int x, GenericFeedConstant y)
      {
         return Add(y, x);
      }
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      public static GenericFeedConstant operator +(double x, GenericFeedConstant y)
      {
         return Add(y, x);
      }
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      public static GenericFeedConstant operator +(GenericFeedConstant x, double y)
      {
         return Add(x, y);
      }
      ...
      /// <param name="y"></param>
      /// <returns></returns>
      public static bool operator >(GenericFeedConstant x, GenericFeedConstant y)
      {
      ...
      #region Implementation of IComparable<GenericFeedConstant>
      ...
      public int CompareTo(GenericFeedConstant other)
      {
         return CompareToInternal(other);
      }

      #endregion Implementation of IComparable<GenericFeedConstant>
   }
}